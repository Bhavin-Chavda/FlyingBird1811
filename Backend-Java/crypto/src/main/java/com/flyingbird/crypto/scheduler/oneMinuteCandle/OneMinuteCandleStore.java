...
/**
 * 1-minute candle data store (owned by the 1m job only).
 *
 ...
 */
@Component
public class OneMinuteCandleStore {
    ...
    public OneMinuteCandleStore(MarketDataProperties props) {
        this.jobId = "fb_1m_job";
