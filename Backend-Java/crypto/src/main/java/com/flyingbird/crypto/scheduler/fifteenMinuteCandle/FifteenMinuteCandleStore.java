...
/**
 * 15-minute candle data store (owned by the 15m job only).
 *
 ...
 */
@Component
public class FifteenMinuteCandleStore {
    ...
    public FifteenMinuteCandleStore(MarketDataProperties props) {
        this.jobId = "fb_15m_job";
